...
const EditDealModal = ({ isOpen, onClose }) => {
  const initialInputs = {
    customer_entity: "",
    Creation_Date: "",
    End_date: "",
    ...
    const fetchOrder = async () => {
      try {
        const response = await axios.get(
          `${API_BASE_URL}/api/Deal/showOneDeal/${id}`,
          {
            headers: {
        ...
        setInputs({
          ...
          Creation_Date: formatDate(orderData.Creation_Date),
          End_date: formatDate(orderData.End_date),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API_BASE_URL}/api/Deal/editDeal/${id}`,inputs, {
        headers: {
          Authorization: `Bearer ${currentUser.accessToken}`,
        },
      });
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-3 gap-2">
                ...
                <div>
                  {renderInput("End_date", "End Date", "End Date", "date")}
                </div>
                <div>
                  {renderInput(
                    "Description",
                ...
                <div>{renderSelect("OEM", "OEM", typeOptions)}</div>
                <div>
